...
<div class="tablem">
    <h3> I currently do not have the funds to continue running this website. I am unable to implement ads due to the nature of this website. The server cost is $8 a month. If you want to keep this website running you can donate to my paypal rondoh80@gmail.com. If you wish to take over I can publish the source code to my github.</h3> 
    <p> Gleamlist is the largest collection of running gleam.io giveaways. Most can be entered in less than 30 seconds.</p>
    <p> Before entering view the terms and conditions provided at the bottom of the linked page.</p>
      <p>Most sponsors will contact the winner by email or through twitter, but will vary from sponsor to sponsor.</p>
  ...
  catch (PDOException $e)
  {
    echo 'Connection failed: ' . $e->getMessage();
      ...
      while($data =$result->fetchObject())
      {
        ...
        <td>
          <p> <?php echo $diff->format('%a days %h hours') ;?></p>
        </td>
...
$order ='added';
$qry3= "Select * from tmp2 where time_end > strftime('%s', 'now') ORDER By time_added desc";
$qry4= "Select * from tmp2 where time_end > strftime('%s', 'now') ORDER By time_end asc";
$qry = $qry4;
